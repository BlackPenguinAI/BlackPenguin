...
class Meeting(Base):
    ...
    visit_location_label = Column(String(180), nullable=True)
    visit_address = Column(Text, nullable=True)
    location_confirmation_status = Column(String(30), default="required", nullable=False)
    location_confirmed_at = Column(DateTime, nullable=True)
    location_confirmed_by = Column(String(30), nullable=True)
